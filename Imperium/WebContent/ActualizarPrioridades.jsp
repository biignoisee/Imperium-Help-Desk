...
<head>
	...
	<title>Actualizar Prioridad - Imperium HelpDesk</title>
...
cada icono con esa nomenclatura ======= -->
  ...
  <main id="main" class="main bg-light mt-2 pl-5 pr-5">
  	<div class="container-fluid mt-5 mb-5 pt-3 pb-3 pl-4 pr-4 bg-white">
		<a href="ControladorPrioridades?accion=listar" class="btn btn-danger text-white p-2 text-decoration-none" style="cursor:pointer;"><i class="bi bi-door-open-fill"></i> Volver a la Lista Prioridad</a>
		<h1 class="mt-3">Actualizar Categoria</h1>
		<p>Desde esta ventana podrá actualizar datos de la categoria</p>
		
		
		<form action="ControladorPrioridades" class="row" method="get">
		<input type = "hidden" name = "id" value = "<c:out value = "${id}"/>">
		
		  <div class="form-group col-sm-6">
		    <label for="titulo">Nombre</label>
		    <input type = "text" class="form-control" name = "nombre_prioridad" value = "<c:out value = "${nombre_prioridad}"/>"/>
		  </div>
		  		  
		  <button type="submit" class="btn btn-primary col-sm-4 ml-3"  name="accion" value="actualizar-prioridad"><i class="fa-solid fa-floppy-disk"></i> Actualizar Categoria</button>
		</form>
	</div>
